...
const slider_nav_data = [
  {
    icon: "/assets/img/slider/4/nav/icon-1.png",
    title: (
      <>
        Ring <br />& Earring
      </>
  ...
  {
    icon: "/assets/img/slider/4/nav/icon-2.png",
    title: (
      <>
        Bangles & <br />
        Bracelets
  ...
  {
    icon: "/assets/img/slider/4/nav/icon-3.png",
    title: (
      <>
        Drop <br /> Necklaces
      </>
  ...
  {
    icon: "/assets/img/slider/4/nav/icon-4.png",
    title: (
      <>
                ...
                <div className="tp-slider-play">
                  ...
                  >
                    <img
                      ...
                      src={"/assets/img/slider/4/shape/rounded-test.png"}
                      alt="text shape"
                      priority
                    />
