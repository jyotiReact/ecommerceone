              ...
              <div className="col-xl-6 col-lg-6">
                <div className="tp-collection-thumb-wrapper-4 p-relative fix z-index-1">
                  <div
                    ...
                    style={{
                      backgroundImage: `url(/assets/img/product/collection/4/collection-1.jpg)`,
                    }}
                  ></div>
              ...
              <div className="col-xl-6 col-lg-6">
                ...
                >
                  <span className="tp-collection-side-text">
                    <img
                      src={"/assets/img/product/collection/4/side-text.png"}
                      alt="text img"
                    />
                  </span>
                      ...
                      <div className="tp-collection-item-4 text-center">
                        ...
                        <div className="tp-collection-thumb-banner-4 m-img">
                          <Link href="/shop">
                            <img
                              src={
                                "/assets/img/product/collection/4/collection-sm-1.jpg"
                              }
